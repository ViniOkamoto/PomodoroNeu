...
import 'package:pomodoroapp/core/router.dart' as Pomodoro;
...
class PomodoroApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [Provider<ThemeStore>(create: (_) => ThemeStore()..getTheme())],
          ...
          builder: (_) {
            if (value.theme != null) {
              return MaterialApp(
                ...
                title: APP_NAME,
                theme: value.theme,
                onGenerateRoute: Pomodoro.Router.generateRoute,
